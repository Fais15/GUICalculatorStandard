...
public class HasilBiodata extends javax.swing.JFrame {
    ...
    /**
     * Creates new form HasilLatihan4
     */
    public HasilBiodata() {
        initComponents();
    }

    HasilBiodata(String nm, String abs, String jur, String almt, String kelas) {
        initComponents();
        Nama.setText(nm);
        Absen.setText(abs);
        Jurusan.setText(jur);
    ...
    private void initComponents() {
        ...
        Nama.setBounds(50, 80, 320, 14);

        Absen.setText("ABSEN");
        getContentPane().add(Absen);
        Absen.setBounds(50, 110, 50, 14);

        Kelas.setText("KELAS");
        getContentPane().add(Kelas);
        Kelas.setBounds(50, 140, 50, 14);

        Jurusan.setText("JURUSAN");
        getContentPane().add(Jurusan);
        Jurusan.setBounds(50, 170, 60, 14);

        Alamat.setText("ALAMAT");
        getContentPane().add(Alamat);
        Alamat.setBounds(50, 200, 310, 14);
